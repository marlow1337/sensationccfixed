...
void StartPrediction(IClientEntity* LocalPlayer, CUserCmd* pCmd)
{
	...
	if (LocalPlayer->IsAlive() && Menu::Window.RageBotTab.AimbotEnginePred.GetState() && !done)
	{
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	else if (FocusOverlayPanel == vguiPanel)
	{
		{
			if (Tick > 5 && Tick < 100)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "S");
			else if (Tick > 100 && Tick < 200)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SE");
			else if (Tick > 200 && Tick < 300)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SEN");
			else if (Tick > 300 && Tick < 400)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SENS");
			else if (Tick > 400 && Tick < 500)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SENSA");
			else if (Tick > 500 && Tick < 600)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SENSAT");
			else if (Tick > 600 && Tick < 700)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SENSATI");
			else if (Tick > 700 && Tick < 800)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SENSATIO");
			else if (Tick > 800 && Tick < 900)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SENSATION");
			else if (Tick > 900 && Tick < 1000)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SENSATION");
			else if (Tick > 1000 && Tick < 1100)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SENSATION.");
			else if (Tick > 1100 && Tick < 1200)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SENSATION.C");
			else if (Tick > 1200 && Tick < 1300)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SENSATION.CC");
			else if (Tick > 1300 && Tick < 1400)
				Render::Text(10, 10, Color(255, 0, 0, 255), Render::Fonts::watermark, "SENSATION.CC");
			else if (Tick > 1400 && Tick < 1500)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "SENSATION.CC");
			else if (Tick > 1500 && Tick < 1600)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "SENSATION.C");
			else if (Tick > 1600 && Tick < 1700)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "SENSATION.");
			else if (Tick > 1700 && Tick < 1800)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "SENSATION");
			else if (Tick > 1800 && Tick < 1900)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "SENSATIO");
			else if (Tick > 1900 && Tick < 2000)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "SENSATI");
			else if (Tick > 2000 && Tick < 2100)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "SENSAT");
			else if (Tick > 2100 && Tick < 2200)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "SENSA");
			else if (Tick > 2200 && Tick < 2300)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "SENS");
			else if (Tick > 2300 && Tick < 2400)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "SEN");
			else if (Tick > 2400 && Tick < 2500)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "SE");
			else if (Tick > 2500 && Tick < 2600)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "S");
			else if (Tick > 2600 && Tick < 2700)
				Render::Text(10, 10, Color(113, 113, 124, 255), Render::Fonts::watermark, "");
			if (Tick > 3600)
				Tick = 0;
			Tick += 3;
		}
